...
use App\DataTables\Admin\HomeBannerDataTable;
use App\Http\Controllers\Controller;
use App\Http\Requests\Admin\HomeBanner\StoreRequest;
use App\Http\Requests\Admin\HomeBanner\UpdateRequest;
...
{
    //
    protected $view = 'admin_dashboard.home_banners.';
    protected $route = 'home_banners.';

    public function index(HomeBannerDataTable $dataTable)
    {
