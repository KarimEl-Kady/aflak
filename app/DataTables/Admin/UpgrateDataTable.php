...
use App\Models\User;
use App\Models\User\UserUpgrate;
...
class UpgrateDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'admin_dashboard.upgrates.action')
            ->setRowId('id');
    }
    ...
    {
        return $model->newQuery()->where('status' ,2);
    }
