...
class AboutUsFeatureDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', 'admin_dashboard.about_us_features.action')
     ...
     */
    public function query(AboutUsFeature $model): QueryBuilder
    {
