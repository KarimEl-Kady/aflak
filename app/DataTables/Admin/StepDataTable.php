...
class StepDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', 'admin_dashboard.steps.action')
        ->editColumn("image", function ($query) {
            if ($query->image_link) {
                ...
                $status = __('messages.doesnt_have_image');
            }
            return $status;
        })
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['data' => 'title', 'title' => __('messages.subject_title')  ,'orderable'=>false,'searchable'=>false],
