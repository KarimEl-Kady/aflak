...
class HashtagDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', 'admin_dashboard.hashtags.action')
        ->rawColumns([
            'action',
        ]);
    }
     ...
     */
    public function query(Hashtag $model): QueryBuilder
    {
