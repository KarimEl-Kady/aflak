...
class HomeBannerDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'homebanner.action')
            ->setRowId('id')
            ...
            ->addColumn('action', 'admin_dashboard.home_banners.action')
            ->rawColumns([
                'image',
                'action',
            ]);
     ...
     */
    public function query(HomeBanner $model): QueryBuilder
    {
    ...
    {
        return 'HomeBanner_' . date('YmdHis');
    }
}
