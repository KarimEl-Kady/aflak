                ...
                <div class="col-lg-5 col-md-8 col-12">
                    <div class="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" name="email"
                            aria-describedby="emailHelp" placeholder="{{ __('messages.enter_your_email_address') }}"
                            required />
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                <div class="logo-footer">
                    <img src="{{ $setting->logo_link ? $setting->logo_link : asset('website/img/title.png') }}"
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="About-company">
                    ...
                    <ul>
                        <a href={{ route('privacies') }}>
                            <li>{{ __('messages.privacy_policy') }}</li>
                        </a>
                        <a href="#">
                            <li>{{ __('messages.terms_and_conditions') }}</li>
                        </a>
                        <a href="{{ route('common_questions') }}">
                            <li>{{ __('messages.common_questions') }}</li>
                        </a>
                        <a href="contact_us">
            ...
            <div class="Made-by">
                <a href="#">
                    <h6>Made by <span>x</span> Coders coding with expert</h6>
                </a>
