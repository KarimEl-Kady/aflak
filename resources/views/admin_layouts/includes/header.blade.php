...
<body id="kt_body"
    ...
    <div id="preloader"><lottie-player src="{{ asset('lotti/lotti_loader.json') }}" background="transparent"
            speed="1" style="width: 200px; height: 200px;" loop autoplay></lottie-player></div>
    <!--end::Header Mobile-->
