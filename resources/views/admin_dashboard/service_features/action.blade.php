<a href="{{route('service_features.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<div style="cursor:pointer;" onclick="deleteservice_features({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
...
<script>
function deleteservice_features(id){
