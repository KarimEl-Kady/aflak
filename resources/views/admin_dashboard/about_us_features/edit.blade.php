...
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('about_us_features.update', $about_us_feature->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="title-{{ $localeCode }}"
                                            value={{ $about_us_feature->translate($localeCode)->title }}>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="text-{{ $localeCode }}"
                                            value={{ $about_us_feature->translate($localeCode)->text }}>
                                    </div>
