<a href="{{route('home_banners.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletehome_banner({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
