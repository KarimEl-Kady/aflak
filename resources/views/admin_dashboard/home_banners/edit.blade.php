        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.edit home_banner') }}</h3>
                </div>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('home_banners.update', $home_banner->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <!-- <img src="{{ $home_banner->image_path }}" alt="Current Image"> -->
                                @error('image')
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required value="{{ $home_banner->link ?? '' }}"
                                    name="link">
                                @error('link')
                                    <span class="invalid-feedback">
                                        {{ $message }}
