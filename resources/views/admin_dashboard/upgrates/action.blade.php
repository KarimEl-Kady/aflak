...
{{-- <a href="{{route('accept_upgrates',$id)}}" class="btn btn-sm btn-hover-bg-light btn-success m-0">
...
<div style="cursor:pointer;" onclick="refuseUpgrate({{$id}})" class="btn btn-sm btn-hover-bg-light btn-danger mr-1">
...
<div style="cursor:pointer;" onclick="acceptUpgrate({{$id}})" class="btn btn-sm btn-hover-bg-light btn-success m-0">
    <span class="svg-icon svg-icon-danger m-0 p-0 svg-icon-md">
        <!-- SVG Icon Code -->
    </span>
    {{__('messages.accept')}}
