<a href="{{route('services.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
...
<div style="cursor:pointer;" onclick="deleteservices({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
