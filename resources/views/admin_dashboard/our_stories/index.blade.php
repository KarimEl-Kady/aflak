...
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('our_stories.update', $our_story->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="title-{{ $localeCode }}"
                                            value="{{ $our_story->translate($localeCode)->title ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="text-{{ $localeCode }}"
                                            value="{{ $our_story->translate($localeCode)->text ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="label_title-{{ $localeCode }}"
                                            value="{{ $our_story->translate($localeCode)->label_title ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="label_text-{{ $localeCode }}"
                                            value="{{ $our_story->translate($localeCode)->label_text ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-8 mx-auto">
                            ...
                            <div id="preview" class="mt-4">
                                @if ($our_story_images)
                                @foreach ($our_story_images as $image)
                                <div class="row">
                                    <div class="col-8 mx-auto">
                                        <div class="preview-image">
                                            <img src="{{ $image->image_link }}" alt="Preview Image" style="max-width: 100%; height: auto;">
                                            <a href="{{ route('our_stories.destroy_stroy_image', $image->id) }}" class="btn btn-danger delete-image">Delete</a>
            ...
            <div class="row feature-container">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <div>
                            <form method="post"
                                  action="{{ route('our_stories.destroy_features', $feature->id) }}">
                                @csrf
                                @method('DELETE')
