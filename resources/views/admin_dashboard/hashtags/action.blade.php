<a href="{{route('hashtags.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletehashtag({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
