        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.add_home_slider') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('about_us.update') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-8 mx-auto">
                            <div class="uploadOuter">
                                <span class="dragBox" id="dragBox">
                                    ...
                                    <input type="file" name="images[]" multiple="multiple" onChange="dragNdrop(event)"
                        ...
                        [].forEach.call(files, function(file) {
                            if (file.type.match('image.*')) {
                                ...
                                reader.onload = function(event) {
                                    ...
                                    img.style.maxWidth = '200px'; // set maximum width for the preview image
                                    img.style.maxHeight = '200px'; // set maximum height for the preview image
