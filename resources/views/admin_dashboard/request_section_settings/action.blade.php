<a href="{{route('request_section_settings.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleterequest_section_settings({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
                            ...
                            <script>
              function deleterequest_section_settings(id){
 ...
 $.ajaxSetup({
  ...
  if (result.isConfirmed) {
    ...
    $.ajax({
       ...
       url: `request_section_settings/${id}`,
       dataType: "Json",
