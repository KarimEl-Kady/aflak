        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.add_request_section_settings') }}</h3>
                </div>
            </div>


            <div class="card-body">
                <form method="post" action="{{ route('request_section_settings.store') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="form-group"> <!-- Apply form-group class -->
                                <div class="text-input"> <!-- Apply text-input class -->
                                    <select name="type" id="type" class="form-control"> <!-- Apply form-control class -->
                                        <option value="1">{{ __('messages.load') }}</option>
                                        <option value="2">{{ __('messages.type') }}</option>
