...
@section('page_title', __('messages.create notification'))
@section('content')
    <div class="container">
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label"> {{ __('messages.create notification') }}</h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control  @error('title') is-invalid @enderror" name="title"
                                    placeholder=" {{ __('messages.title') }}  ">{{ old('title') ?? '' }} </textarea>
                                @error('title')
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control  @error('text') is-invalid @enderror" name="text"
                                    placeholder=" {{ __('messages.text') }}  ">{{ old('text') ?? '' }} </textarea>
                                @error('text')
                                    <span class="invalid-feedback">
                                        {{ $message }}</span>
                                @enderror
