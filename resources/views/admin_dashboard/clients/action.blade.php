<a href="{{route('clients.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteclient({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
