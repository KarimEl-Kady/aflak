<a href="{{route('payment_ways.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deletepayment_way({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
