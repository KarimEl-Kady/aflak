                ...
                <form method="post" action="{{ route('blogs.update', $blog->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="title-{{ $localeCode }}" value="{{ $blog->translate($localeCode)->title }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="select">
                                <select class="form-select selectpicker" multiple aria-label="Default select example" name="section_ids[]" id="section_ids[]">
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @if (in_array($section->id, $blog->sections->pluck('id')->toArray())) selected @endif>{{ $section->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="select">
                                <select class="form-select selectpicker" multiple aria-label="Default select example" name="hashtag_ids[]" id="hashtag_ids[]">
                                    @foreach ($hashtags as $hashtag)
                                        <option value="{{ $hashtag->id }}" @if (in_array($hashtag->id, $blog->hashtags->pluck('id')->toArray())) selected @endif>{{ $hashtag->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="text-input">
                                        <input type="text" class="form-control" name="description-{{ $localeCode }}" value="{{ $blog->translate($localeCode)->description }}">
                                    </div>
                                </div>
                            </div>
                        @endforeach
