<a href="{{route('blogs.edit',$id)}}" class="btn btn-sm btn-hover-bg-light m-0">
                            ...
                            <div style="cursor:pointer;" onclick="deleteblog({{$id}})" class="btn btn-sm btn-hover-bg-light mr-1">
